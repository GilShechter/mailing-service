...
public class PostOfficeController {
    ...
    public ResponseEntity<?> getOnePostOffice(@PathVariable Long id) {
        return new ResponseEntity<>(postOfficeService.findById(id), HttpStatus.OK);
    }

    @RequestMapping(value = "", method = RequestMethod.POST)
    public ResponseEntity<?> insertPostOffice(@RequestBody PostOfficeIn postOfficeIn) {
    ...
    public ResponseEntity<?> updatePostOffice(@PathVariable Long id, @RequestBody PostOfficeIn postOfficeIn) {
